...
%		\usepackage{apacite}
		...
		\begin{document}
				...
				Accurately named after the actor from the movie ghost. This is an effect where the user isn't acknowledged in the world. 
				...
				Only one thing happening at a time in the world.
				...
				\begin{figure}[h!]
					...
					\caption{Mapping into objects.} 
					\label{fig:area_object}
				\end{figure}
			\todo{make better caption.}
